...
```
irm https://github.com/Rifanse/CIRS-Ai-Agent-Framework-/edit/main/install.ps1 | iex
```
...
:man_technologist: Dev :  [@CMr_zo](https://github.com/Rifanse)
